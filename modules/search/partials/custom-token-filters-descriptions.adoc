...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=dict_compound_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=edge_ngram_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=elision_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=keyword_marker_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=length_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=ngram_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=normalize_unicode_filter]
----
// end::normalize[]
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=shingle_filter]
----

For example, if you use a xref:search/customize-index.adoc#whitespace[whitespace tokenizer], a range with a minimum of two and a maximum of three, and a space as a separator, the token `abc def` becomes `abc`, `def`, and `abc def`.
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=stop_tokens_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=truncate_token_filter]
----
