...
* *ivf,rabitq*: From Couchbase Server version 8.5 and later, choose this option to use https://github.com/VectorDB-NTU/RaBitQ-Library[RaBitQ quantization^] with an inverted file index.
+
...
* *bivf-flat*: From Couchbase Server version 8.5 and later, choose this option to use binary quantization with a FLAT index.
+
...
* *bivf-sq8*: From Couchbase Server version 8.5 and later, choose this option to use binary quantization with an SQ8 index.
+
