...
For a `vector` child field, choose the method to calculate the similarity between the vector embedding in a Search Vector Index and the vector embedding in a Vector Search query.
