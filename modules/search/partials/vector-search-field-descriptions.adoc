...
From Couchbase Server version 8.5 and later, for a `vector` child field, choose whether the Search Service should use your cluster's GPU or GPUs for indexing, training, and query processing.
