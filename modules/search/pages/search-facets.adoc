...
From Couchbase Server version 8.5 and later, you can filter the contents of the term facets collected for your documents during a search by configuring an additional filter.
