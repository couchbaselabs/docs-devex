...
|&check;
|&check;
a|From Couchbase Server version 8.5 and later, you can use a nested object mapping to preserve the relationships between fields when you have an array of objects in your documents.
...
* xref:create-nested-object.adoc[]
