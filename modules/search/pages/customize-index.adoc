...
Mappings contain type mappings, and usually correspond to whole collections or parent fields. 
...
Add child fields to a mapping to create a static type mapping.
