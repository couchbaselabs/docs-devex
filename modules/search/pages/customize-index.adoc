...
|&check;
|&check;
a|As of Couchbase Server version 8.1, you can use a nested object mapping to preserve the relationships between fields when you have an array of objects in your documents.
