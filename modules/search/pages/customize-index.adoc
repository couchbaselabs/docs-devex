...
Add mappings for JSON objects or child fields to type mappings to improve your Search index's performance, instead of indexing entire collections. 
...
Configure this type of mapping by selecting a collection or use the *Object* option in xref:create-search-index-ui.adoc[Advanced Mode].
...
Configure this type of mapping by selecting a field and using the *Child* option in xref:create-search-index-ui.adoc[Advanced Mode].
