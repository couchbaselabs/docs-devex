...
include::partial$custom-tokenizer-regexp-steps.adoc[]
--
...
+
For more information about the available tokenizers, see xref:search/customize-index.adoc#tokenizers[Tokenizers].
. Click btn:[Save].
--
