...
To create a custom token filter with the Couchbase {page-ui-name}: 
...
To create a new `dict_compound` token filter with the Couchbase {page-ui-name}: 
...
To create a new `edge_ngram` token filter with the Couchbase {page-ui-name}: 
...
To create a new `elision` token filter with the Couchbase {page-ui-name}: 
...
To create a new `keyword_marker` token filter with the Couchbase {page-ui-name}: 
...
To create a new `length` token filter with the Couchbase {page-ui-name}: 
...
To create a new `ngram` token filter with the Couchbase {page-ui-name}: 
...
To create a new `normalize_unicode` token filter with the Couchbase {page-ui-name}:
...
To create a new `shingle` token filter with the Couchbase {page-ui-name}: 
...
To create a new `stop_tokens` token filter with the Couchbase {page-ui-name}: 
...
To create a new `truncate_token` token filter with the Couchbase {page-ui-name}: 
