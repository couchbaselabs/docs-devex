...
These mappings can be <<static,>> or <<dynamic,>>.
...
Your type identifier tells the Search Service how to interpret a document's type.
...
Or, in the xref:create-quick-index.adoc[Quick Editor], select a document field in your document schema to create a static type mapping.
