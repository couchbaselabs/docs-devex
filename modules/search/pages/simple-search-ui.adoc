...
. (Optional) To directly edit the xref:search-request-params.adoc[Search request JSON payload] for your Search query and run a new search:
...
You can edit the JSON payload directly in the UI by clicking *show advanced query settings*. 
