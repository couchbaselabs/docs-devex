...
As of Couchbase Server version 8.1, you can now configure a Search index to avoid flattening xref:create-nested-object.adoc[arrays of objects] in your documents. 
