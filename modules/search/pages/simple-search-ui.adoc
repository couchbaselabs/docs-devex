...
From Couchbase Server version 8.5 and later, you can now configure a Search index to avoid flattening xref:create-nested-object.adoc[arrays of objects] in your documents. 
