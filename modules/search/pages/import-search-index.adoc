...
. On the *Databases* page, select the cluster where you want to import a JSON Search index definition.
...
. On the *Databases* page, select the cluster where you want to import a JSON Search index alias.
. Go to menu:Data Tools[Search].
