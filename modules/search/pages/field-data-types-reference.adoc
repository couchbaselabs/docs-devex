...
When you xref:search/create-child-field.adoc[create a child field] on a type mapping, you need to set the field's data type. 

You also need to choose a field data type when you xref:search/create-quick-index.adoc[create a quick index].
