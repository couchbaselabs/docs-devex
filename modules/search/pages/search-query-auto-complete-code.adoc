...
.. xref:search-query-auto-complete-ui.adoc#search-index[Create an autocomplete Search index with the UI].
.. xref:create-search-index-rest-api.adoc[] with the following JSON payload and update the placeholder values to match your own dataset:
+
[source,json]
----
