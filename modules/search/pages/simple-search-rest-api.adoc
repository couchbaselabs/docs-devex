...
From Couchbase Server version 7.6.2 and later, you can also copy a full command-line curl example from the {page-ui-name} to use with the REST API, or edit a generated Search query with the built-in code editor.
