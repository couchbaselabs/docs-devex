...
+
TIP: You can copy the JSON for a Search query from the Couchbase {page-ui-name} to use in your REST API call.
...
You can also copy a full command-line curl example from the {page-ui-name} to use with the REST API, or edit a generated Search query with the built-in code editor.
