...
+
For example, if you wanted your Search index to only return documents that have an prefix of `hotel_`, you could enter `scope.collection.hotel` in the type mapping *Name* field.
. Click btn:[Submit].
. Click btn:[Update Index].
