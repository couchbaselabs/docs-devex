...
:description: Add autocomplete to your application to provide a search engine-like experience for your cluster. 
...
To use autocomplete with the Search Service and your Couchbase {page-product-name} cluster:
