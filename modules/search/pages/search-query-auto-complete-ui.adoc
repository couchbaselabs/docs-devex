...
:description: Create a Search index with the {page-ui-name} or the REST API to start using autocomplete with the Search Service.
...
You can create a compatible Search index with the <<ui,{page-ui-name} in Advanced Mode>> or the <<api,REST API>>.  

[#ui]
=== Create an Autocomplete Search Index with the {page-ui-name}
