...
. In the *Bucket*, *Scope*, and *Collection* lists, choose the bucket and scope where you want to create your Search index, and the collections you want to include. 
...
.. In the *Token Filters* list for your custom analyzer, click both the *to_lower* and your custom *edge_ngram_2_8* token filter.
. xref:create-search-index-ui.adoc#configure-settings[Set your default analyzer] to your custom *keyword_to_lower* analyzer.
. Under *Type Mappings*, in your document schema, click the name of a field that contains the data you want to search. 
. Configure the field: 
