...
. In the *Layout Style* list, choose the specific layout style you want to use for your date/time parser.
+
For more information, see xref:date-time-parser-layout-styles.adoc[].
. In the *Layout to be added* field, enter your date/time layout, based on your chosen Layout Style. 
. Click btn:[Add]. 
