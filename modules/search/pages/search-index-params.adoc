...
|name |String |Yes |The name of the Search index.
...
|sourceUUID |String |No |The UUID of the bucket where you want to create the Search index.
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=9..13]
----
...
|indexPartitions |Number |Yes |The number of partitions to split the Search index into, across the nodes you have available in your database with the Search Service enabled. 
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=15..20]
----
...
Set how the Search index identifies a document's type: 
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=21..96]
----
...
To include the values for an indexed field in the Search index, set `docvalues_dynamic` to `true`.
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=23..37]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=24..36]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=38..44]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=39..43]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=45..57]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=46..52]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=58..64]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=59..63]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=65..74]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=66..73]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=75..82]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=76..81]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=87..90]
----
...
The default type mapping includes all documents in the bucket in the Search index, even if they don't match another configured type mapping.
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=96..140]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=97..139]
----
...
To enable the type mapping and include any documents that match it in the Search index, set `enabled` to `true`. 

To remove any documents that match this type mapping from the Search index, set `enabled` to `false`.
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=101..122]
----
...
[source,json]
----
include::example$simple-search-index-payload.jsonc[lines=108..119]
----
