...
:description: You can control the settings for a Search index with a JSON payload. 
:page-toclevels: 3

{description}

When you xref:create-search-index-rest-api.adoc[create a Search index with the REST API], you need to create a JSON payload with the settings for the new Search index.
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=initial]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=planparams]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=doc_config]
----
...
The `mapping` object contains a Search index's analyzers and other xref:set-advanced-settings.adoc[advanced settings from the UI].

[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=mapping]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=analyzers]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=char_filter]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=tokenizers]
----
...
If the tokenizer's `type` value is `exception`, give a xref:customize-index.adoc#tokenizers[default tokenizer] to apply to the tokens created with the `exceptions` array.
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=token_filters]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=token_maps]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=date_time]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=default_mapping]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=types]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=child_field]
----
...
[source,json]
----
include::example$complex-search-index-payload.jsonc[tag=fields]
----
...
For more information on the available field data types, see xref:field-data-types-reference.adoc[].
