...
For more information about Vector Search indexes, see xref:vector-search:vector-search.adoc[].
...
|similarity |String |Vector Only a|
...
//Provide more context on the differences.
