...
An object that controls memory management and file merging behavior for the Search index.
...
The `store` object can change settings for merging and in-memory buffer processing on your Search index.
