...
[NOTE]
====
For indexes created with version 7.6, index names must be unique inside a bucket and scope.
...
Indexes created with a previous version are not scoped. 
==== 
...
[NOTE]
====
All index names must be unique inside a bucket and scope.
