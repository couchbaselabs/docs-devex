...
From Couchbase Server version 7.6.2 and later, the {page-ui-name} lets you generate a command-line curl example or edit the JSON for your query using a built-in code editor.
