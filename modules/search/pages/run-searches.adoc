...
As of Couchbase Server version 8.1, you can also choose a specific algorithm to combine the scores of a regular Search and Vector Search query. 

For more information about the available algorithms and how to set your score fusion algorithm in your query, see xref:score-fusion/about-score-fusion.adoc[].
