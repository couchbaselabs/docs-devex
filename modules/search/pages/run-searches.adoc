...
If you're using the xref:score-fusion/about-score-fusion.adoc#rrf[Reciprocal Rank Fusion (RRF) algorithm] for your query, your `boost` values might not have any affect on your search results, unless they move a document across a rank boundary.

If you use the xref:score-fusion/about-score-fusion.adoc#rsf[Relative Score Fusion (RSF) algorithm], boosting might have more of an affect on search results.
...
* If you use the xref:score-fusion/about-score-fusion.adoc#rrf[Reciprocal Rank Fusion (RRF) algorithm] for your query, your `boost` values might not have any affect on your search results, unless they move a document across a rank boundary.
