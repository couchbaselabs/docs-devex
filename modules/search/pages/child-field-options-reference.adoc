...
:page-aliases: fts:fts-type-mappings-add-child-field-docvalues.adoc
...
|[[similarity-metric]]Similarity Metric (Vector Fields Only) a|
...
|[[analyzer]]Analyzer (Text Fields Only) a|
...
|Synonym Source (Text Fields Only) a|

Choose a synonym source to use for synonym searches in the child field.

Adding a synonym source supports running a search for a single term, and returning matches for other terms that share a similar meaning. 
You can define your own thesaurus for synonym relationships across terms, using synonym documents. 

For more information about how to create synonym documents, see xref:synonyms/create-synonym-collection-docs.adoc[].

For more information about how to add a new synonym source for your child fields, see xref:synonyms/add-synonym-source.adoc[].

|[[datetime-parser]]Datetime Parser (Datetime Fields Only) a|

Choose the xref:customize-index.adoc#date-time[date/time parser] you want to use to interpret date and time data in the child field.

You can choose a default date/time parser or a custom parser.

For more information about the default date/time parsers, see xref:default-date-time-parsers-reference.adoc[].

For more information about creating a custom date/time parser, see xref:create-custom-date-time-parser.adoc[].
