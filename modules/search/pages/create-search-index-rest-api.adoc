...
For more information about how to create an index with the UI, see xref:search/create-search-index-ui.adoc[].
...
----
+
For more information on the available JSON properties for a Search index, see xref:search/search-index-params.adoc[].