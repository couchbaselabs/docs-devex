...
+
TIP: You can copy the Search index definition JSON payload from the Couchbase Capella UI to use in your REST API call, if you remove the xref:search-index-params.adoc#uuid[uuid] and xref:search-index-params.adoc#sourceuuid[sourceUUID] parameters.
