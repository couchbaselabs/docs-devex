...
For more information about how to size your cluster for using the Search Service, see xref:server:install:sizing-general.adoc#sizing-search-service-nodes[Sizing Search Service Nodes].
