= Set Search Index General Settings with the Capella UI
:page-topic-type: guide 
:description: Configure general settings for a Search index to improve an index's search results and performance. 
