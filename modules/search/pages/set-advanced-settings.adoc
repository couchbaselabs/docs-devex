...
If your Search index cannot assign a document's type using your xref:customize-index.adoc#type-identifiers[type identifier], set the default type assigned to documents in the index.
