...
////
|[[default-type]]Default Type a|

If your Search index cannot assign a document's type using your xref:customize-index.adoc#type-identifiers[type identifier], set the default `type` value to assign to those documents.
////
...
|[[synonym]]Default Synonym Source a|

Change the default xref:synonyms/synonyms-search.adoc[Synonym Source] to use for fields in your Search index. 

For more information about how to create a synonym source, see xref:synonyms/add-synonym-source.adoc[].
