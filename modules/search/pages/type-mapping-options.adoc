...
Choose a synonym source to use for synonym searches on text in this field.
...
For more information about how to add a new synonym source for your text field type mappings, see xref:synonyms/add-synonym-source.adoc[].
...
|[[optimized]]Optimized For (Vector Fields Only) 
