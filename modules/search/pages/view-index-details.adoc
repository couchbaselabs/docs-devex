...
:description: Use the Index Details page in the Couchbase {page-ui-name} to view partition layouts, query history, and query execution times. 
...
* Your user account has the xref:learn:security/roles.adoc#search-admin[`Search Admin`] role for the bucket where you created your Search index.
...
For more information about viewing Search query history on your cluster, see xref:view-query-history.adoc[].
