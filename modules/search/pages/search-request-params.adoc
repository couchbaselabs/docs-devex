...
The Search Service returns the `k` closest vectors to the vector given in `vector` or `vector_base64`.
...
Enter a vector, encoded as a base64 string, that you want to compare to the vector data in `field`. 
