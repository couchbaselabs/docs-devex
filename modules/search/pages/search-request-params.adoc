...
If you used a higher `score_rank_constant`, such as a value between `60` or `100`, Document B should rank higher than Document A, due to the document having a consensus, or ranking on both searches.
