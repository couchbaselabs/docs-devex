...
From Couchbase Server version 8.5 and later, you can paginate on numeric, date, and geo fields, in addition to text fields, document IDs, and result scores.
To paginate on numeric, date, and geo fields, you must sort with <<sort,objects>> that set the field type.
For more information, see xref:manage-search-pagination.adoc#non-textual[Paginate on Numeric, Date, and Geo Fields].
...
For more information about how to paginate search results, see xref:manage-search-pagination.adoc[].
