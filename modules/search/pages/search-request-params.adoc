...
The Search Service automatically calculates a default `nprobe` percentage based on the vectors in a given partition of your Search Vector Index.
...
For more information, see xref:guides:kv-operations.adoc[].
