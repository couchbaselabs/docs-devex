...
From Couchbase Server version 8.1 and later, if your Search Vector Index uses xref:vector-search:vector-search-index-architecture.adoc#index-formats[binary quantization], your query vector does not need to use binary values instead of floats.
====
