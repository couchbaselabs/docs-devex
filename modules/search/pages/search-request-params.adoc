...
Before Couchbase Server version 7.6.9, the Search Service picked only the top `k` vectors, which could cause the same document to be returned multiple times if it had the best matching vectors.
