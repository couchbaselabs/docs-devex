...
If you are collecting a xref:search-facets.adoc#term-facet[Term Facet], add a `term_prefix` property to add a prefix filter to the facets collected by your search.
...
If you are collecting a xref:search-facets.adoc#term-facet[Term Facet], add a `term_pattern` property to add a regular expression filter to the facets collected by your search.
