= Create a Child Field with the Web Console
:page-topic-type: guide
:description: Create a child field to add or remove content from a specific field in your documents from a Search index.
