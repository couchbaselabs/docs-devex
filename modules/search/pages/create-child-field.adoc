= Create a Child Field with the Server UI
:page-topic-type: guide
:tabs:

Create a child field with the Couchbase Server Web Console to add or remove specific fields from documents in a Search Index.
