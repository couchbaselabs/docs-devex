...
Couchbase Server is a distributed NoSQL developer database platform that delivers unmatched versatility, performance, scalability, and financial value for your critical applications.
The speedy Data Service is complemented by a familiar, SQL-like language for our Query Service, {sqlpp}.

This section introduces developing with the services, and links to the REST API references.
If you want to jump straight to our xref:home:ROOT:sdk.adoc[SDKs], and develop for self-managed Couchbase Server in your favourite language, follow the links below:
...
Otherwise, explore the rest of the developer section.
