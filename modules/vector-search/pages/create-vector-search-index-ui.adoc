= Create an Search Vector Index in Quick Mode
:page-topic-type: guide
:page-ui-name: {ui-name}
:page-product-name: {product-name}
:page-toclevels: 2
:description: Use Quick Mode to create an Search Vector Index in Couchbase Capella.
...
To create an Search Vector Index in Capella:
...
+
The Search Service supports arrays up to 4096 elements.
...
TIP: After you create your Search Vector Index, click the index name to go back into the editor and add additional collections or child field type mappings to your index.
...
This basic Search Vector Index includes the vector embeddings from the child field you specified in your type mapping.
...
For more information about how to run a search against an Search Vector Index, see xref:run-vector-search-ui.adoc[].