= Create an FTS Vector Index with the {page-ui-name}
:page-topic-type: guide
:page-ui-name: {ui-name}
:page-product-name: {product-name}
:page-toclevels: 2
:description: You can create an FTS Vector Index with the Couchbase {page-ui-name}. 
...
To create an FTS Vector Index with the Couchbase {page-ui-name}: 
...
A basic FTS Vector Index includes the vector embeddings from the child field you specified in your type mapping.
...
For more information about how to run a search against an FTS Vector Index, see xref:run-vector-search-ui.adoc[] or xref:run-vector-search-rest-api.adoc[].