...
+
TIP: You can copy the JSON for a Query Request from the Couchbase Server Web Console to use in your REST API call.
...
[source,console]
----
include::example$run-vectorsearch-payload.sh[]
----
+
