...
For more information about how the Search Service scores documents in search results, see xref:run-searches.adoc#hybrid[Hybrid Searches with a Search Vector Index].
