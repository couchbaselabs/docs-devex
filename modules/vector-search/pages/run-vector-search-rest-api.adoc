...
For more information about how the Search Service scores documents in search results, see xref:search:run-searches.adoc#hybrid[Hybrid Searches with a Search Vector Index].
...
. Enter your username, password, and the Search Service endpoint on port `8094` with the name of the Search Vector Index you want to query: 
+
[source,console]
----
