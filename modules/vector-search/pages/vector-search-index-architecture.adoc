...
For more information about how to enable this setting for your Search Vector Index, see xref:search:set-advanced-settings.adoc#fast-merge[Set Search Index Advanced Settings] or the xref:search:search-index-params.adoc#fast-merge[`store` object].
