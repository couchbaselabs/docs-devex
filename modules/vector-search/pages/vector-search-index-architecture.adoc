...
* *bivf-sq8*: If your cluster is running Couchbase Sever version 8.1 or later, Vector Search uses <<ivf-binary,binary quantization>>.
* *ivf,rabitq*: If your cluster is running Couchbase Sever version 8.1 or later, Vector Search uses <<ivf-binary,RaBitQ quantization>>.
...
From Couchbase Server version 8.1 and later, if xref:search:child-field-options-reference.adoc#optimized[Optimized For] is set to: 
...
From Couchbase Server version 8.1 and later, if xref:search:child-field-options-reference.adoc#optimized[Optimized For] is set to *bivf-flat*, Vector Search uses <<flat-binary,binary quantization>>.
|====
...
From Couchbase Server version 8.1 and later, if you want to use binary quantization, the Search Service converts each element in your vectors to a bit.
