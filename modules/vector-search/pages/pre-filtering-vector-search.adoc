...
. Add the `index name` you wish to query to the endpoint.
...
A pre-filter on the index will narrow the index entries searched over to those closely matching navy.
