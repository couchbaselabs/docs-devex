...
NOTE: When you create an Search Vector Index, the xref:search:type-mapping-options.adoc#dimension[dimension] of your data vector embeddings must match the dimension for any search query vectors.
