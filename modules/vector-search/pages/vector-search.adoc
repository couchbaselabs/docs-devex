...
As of Couchbase Server version 8.1, you can also choose the specific fusion algorithm the Search Service uses to combine scoring for standard Search and Vector Search queries.
