...
You can also use xref:ai:build:model-service/deploy-embed-model.adoc[Capella AI Services] to generate and store embeddings in your {page-product-name} operational cluster.

NOTE: When you create a Search Vector Index, the xref:search:type-mapping-options.adoc#dimension[dimension] of your data vector embeddings must match the dimension for any search query vectors.
