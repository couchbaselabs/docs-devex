...
You can also use xref:ai:build:model-service/deploy-embed-model.adoc[the {ai-long}] to generate and store embeddings in your {page-product-name} operational cluster.
