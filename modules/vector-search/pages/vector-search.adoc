...
From Couchbase Server version 8.1 and later, Search Vector Indexes include new optimization features to improve performance with large numbers of vectors.
