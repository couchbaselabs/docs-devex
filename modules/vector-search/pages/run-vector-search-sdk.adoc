...
For the best results, consider using the sample Search Vector Index from xref:create-vector-search-index-ui.adoc#example[Create an Search Vector Index in Quick Mode].
--
...
You can xref:search:create-search-index-ui.adoc#add-mapping[create an additional mapping] to update your Search Vector Index to include the `description` field with your search results.
