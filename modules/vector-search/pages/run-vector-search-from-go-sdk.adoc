= Run a Vector Search with the Go SDK
:page-topic-type: guide
:page-ui-name: {ui-name}
:page-product-name: {product-name}
:description: Using Couchbase's Go SDK, you can run a simple or more complex vector search against a Vector Search index.
...
* Make sure to install the Couchbase Go SDK
+
For more information about on installing and using the Couchbase Go SDK, see xref:go-sdk:hello-world:start-using-sdk.adoc[Start Using the Go SDK].

== Example: Searching for a Similar Color Vector with a Go Program 
...
[source,go]
----
include::example$RunVectorSearchSimpleColor.go[]
----
...
[source,go]
----
include::example$RunVectorSearchGenerateEmbed.go[]
----
