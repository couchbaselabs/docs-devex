...
NOTE: This sample JSON Search Vector Index is the same as the one provided in xref:create-vector-search-index-ui.adoc[].
...
If you want to edit your index with another REST API call, include the xref:search:search-index-params.adoc#uuid[uuid] parameter with the UUID the Search Service assigned to your Search Vector Index.
