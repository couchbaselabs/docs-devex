...
----
<.> In this case, the User-Defined Function will be created for the JavaScript function under the current
ifdef::tools[xref:tools:query-workbench.adoc#query-context[query context].]
ifndef::tools[query context.]
