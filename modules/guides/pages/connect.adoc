...
To access a cluster via the Couchbase Server Web Console over an _unencrypted_ connection, navigate to the Web Console address with your browser (by default, `pass:[http://localhost:8091]`) and enter your credentials.
...
To access a cluster via the Couchbase Server Web Console over an _encrypted_ connection, navigate to the secure Web Console address with your browser (by default, `pass:[https://localhost:18091]`) and enter your credentials.
...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$ManagingConnections.csx[tag=simpleconnect,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$auth.js[tag=rbac-auth,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:howtos:example$managing_connections.py[tag=simpleconnect,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Auth.csx[tag=auth,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$auth.js[tag=tls-cacert,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:howtos:example$managing_connections.py[tag=tls,indent=0]
----
