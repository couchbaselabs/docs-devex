...
[source,java]
----
include::3.4@java-sdk:howtos:example$ManagingConnections.java[tag=simpleconnect,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Auth.java[tag=certauth,indent=0]
----
