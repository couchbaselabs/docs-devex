...
For more information and examples, see xref:n1ql:n1ql-language-reference/delete.adoc[DELETE].
...
If any flights are using equipment 319, they're updated to use 797.
If any flights are using equipment 757, they're deleted.
