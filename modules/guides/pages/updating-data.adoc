...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$KvHelloWorldScoped.csx[tag=kv-update-upsert,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvHelloWorldScoped.java[tag=kv-update-upsert,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$kv-hello-world-scoped.js[tag=kv-update-upsert,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/kv_hello_world_scoped.py[tag=kv-update-upsert,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$KvHelloWorldScoped.csx[tag=kv-update-replace,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvHelloWorldScoped.java[tag=kv-update-replace,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$kv-hello-world-scoped.js[tag=kv-update-replace,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/kv_hello_world_scoped.py[tag=kv-update-replace,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$KvHelloWorldScoped.csx[tag=kv-update-subdoc,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvHelloWorldScoped.java[tag=kv-update-subdoc,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$kv-hello-world-scoped.js[tag=kv-update-subdoc,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/kv_hello_world_scoped.py[tag=kv-update-subdoc,indent=0]
----
