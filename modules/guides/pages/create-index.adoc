...
[source,sqlpp]
----
include::performance:example$create-idx-expr.n1ql[]
----
...
[source,sqlpp]
----
include::performance:example$create-idx-composite.n1ql[]
----
...
[source,sqlpp]
----
include::performance:example$create-idx-array.n1ql[]
----
====
...
[source,sqlpp]
----
include::performance:example$create-idx-partial.n1ql[]
----
====
