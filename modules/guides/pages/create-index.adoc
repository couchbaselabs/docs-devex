...
[source,sqlpp]
----
include::example$query/create-gsi-elixir.n1ql[]
----
...
[source,sqlpp]
----
include::example$query/create-composite-elixir.n1ql[]
----
...
[source,sqlpp]
----
include::example$query/create-array-elixir.n1ql[]
----
====
...
[source,sqlpp]
----
include::example$query/create-partial-elixir.n1ql[]
----
====
