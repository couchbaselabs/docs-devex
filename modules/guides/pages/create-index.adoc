...
For more information and examples, see xref:indexes:indexing-and-query-perf.adoc#partial-index[Partial Index].
...
For more information and examples, see xref:indexes:covering-indexes.adoc[Covering Indexes].
