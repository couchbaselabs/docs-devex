...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=primary,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=named-primary,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=primary,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=named-primary,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=primary,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=named-primary,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=primary,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=named-primary,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=secondary,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=secondary,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=secondary,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=secondary,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=composite,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=composite,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=composite,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=composite,indent=0]
----
