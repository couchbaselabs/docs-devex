...
[source,python]
----
include::python-sdk:howtos:example$query_index_manager.py[tag=primary,indent=0]
----
...
[source,python]
----
include::python-sdk:howtos:example$query_index_manager.py[tag=named-primary,indent=0]
----
...
[source,sqlpp]
----
include::server:learn:example$services-and-indexes/indexes/create-idx-expr.n1ql[]
----
...
[source,python]
----
include::python-sdk:howtos:example$query_index_manager.py[tag=secondary,indent=0]
----
...
[source,sqlpp]
----
include::server:learn:example$services-and-indexes/indexes/create-idx-composite.n1ql[]
----
...
[source,python]
----
include::python-sdk:howtos:example$query_index_manager.py[tag=composite,indent=0]
----
