...
[source,sh]
----
include::example$kv/kv-cbc.nu[tag=cbsh-bulk-insert]
----
...
+
--
. Create an array containing a list of document IDs.
...
[source,sh]
----
include::example$kv/kv-cbc.nu[tag=cbsh-bulk-get]
----
...
[source,sh]
----
include::example$kv/kv-cbc.nu[tag=cbsh-bulk-upsert]
----
...
[source,sh]
----
include::example$kv/kv-cbc.nu[tag=cbsh-bulk-delete]
----
