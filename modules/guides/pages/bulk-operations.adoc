...
[source,java]
----
include::java-sdk:devguide:example$java/KvBulkHelloWorld.java[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,java]
----
include::java-sdk:devguide:example$java/KvBulkHelloWorld.java[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,java]
----
include::java-sdk:devguide:example$java/KvBulkHelloWorld.java[tags=kv-users;kv-bulk-upsert,indent=0]
----
...
[source,java]
----
include::java-sdk:devguide:example$java/KvBulkHelloWorld.java[tags=kv-users;kv-bulk-remove,indent=0]
----
