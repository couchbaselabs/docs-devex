...
[source,nodejs]
----
include::nodejs-sdk:devguide:example$nodejs/kv-bulk-hello-world.js[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,nodejs]
----
include::nodejs-sdk:devguide:example$nodejs/kv-bulk-hello-world.js[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,nodejs]
----
include::nodejs-sdk:devguide:example$nodejs/kv-bulk-hello-world.js[tags=kv-users;kv-bulk-upsert,indent=0]
----
...
[source,nodejs]
----
include::nodejs-sdk:devguide:example$nodejs/kv-bulk-hello-world.js[tags=kv-users;kv-bulk-remove,indent=0]
----
...
| xref:rust-sdk:howtos:concurrent-async-apis.adoc[Rust]
