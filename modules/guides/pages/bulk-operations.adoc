...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$KvBulkHelloWorld.csx[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvBulkHelloWorld.java[tag=kv-bulk-class,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$kv-bulk-hello-world.js[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/kv_bulk_hello_world.py[tags=kv-users;kv-bulk-insert,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$KvBulkHelloWorld.csx[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$kv-bulk-hello-world.js[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/kv_bulk_hello_world.py[tags=kv-users;kv-bulk-get,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-upsert,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$kv-bulk-hello-world.js[tags=kv-users;kv-bulk-upsert,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/kv_bulk_hello_world.py[tags=kv-users;kv-bulk-upsert,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$KvBulkHelloWorld.csx[tags=kv-users;kv-bulk-remove,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$KvBulkHelloWorld.java[tags=kv-users;kv-bulk-remove,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$kv-bulk-hello-world.js[tags=kv-users;kv-bulk-remove,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/kv_bulk_hello_world.py[tags=kv-users;kv-bulk-remove,indent=0]
----
