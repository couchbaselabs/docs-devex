...
. Click the btn:[options] button to display the Query Options window.
...
. Choose btn:[Save Settings] to save the preferences and return to the Query Workbench.
...
+
--
To execute a statement as a transaction, switch the *transaction* toggle on, enter the statement in the Query Editor and click btn:[Run Query].
