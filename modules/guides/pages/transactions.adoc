...
. To display the Query Options dialog, click btn:[options].
...
image::elixir-transaction-settings.png['The Query Options dialog, with Scan Consistency set to "not_bounded", Transaction Timeout set to "120", and named parameter "durability_level" set to "none"']
...
. Next to your bucket in the Data Insights sidebar, click the *More Options* (⋮) button, then btn:[Add Scope].
. Enter the name "tenants" in the *Scope Name* field, then click the btn:[Create Scope] button.
. Next to the new tenants scope, click the *More Options* (⋮) button, then btn:[Add Collection]. 
