...
. To display the Run-Time Preferences window, click the cog icon icon:cog[].
...
For the new named parameter, enter the name in the *name* box and a value in the *value* box.

. To save the preferences and return to the Query Workbench, click btn:[Save Preferences].
...
For more information, see xref:n1ql:n1ql-language-reference/transactions.adoc#settings-and-parameters[Transaction Settings and Parameters].
...
For more information, see xref:n1ql:n1ql-language-reference/begin-transaction.adoc[BEGIN TRANSACTION].
...
For more information, see xref:n1ql:n1ql-language-reference/set-transaction.adoc[SET TRANSACTION].
...
For more information, see xref:n1ql:n1ql-language-reference/savepoint.adoc[SAVEPOINT].
...
For more information, see xref:n1ql:n1ql-language-reference/rollback-transaction.adoc[ROLLBACK TRANSACTION].
...
For more information, see xref:n1ql:n1ql-language-reference/commit-transaction.adoc[COMMIT TRANSACTION].
...
* C
| xref:cxx-txns:howtos:distributed-acid-transactions-from-the-sdk.adoc[{cpp}]
...
| xref:nodejs-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Node.js]
