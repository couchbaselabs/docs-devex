...
:lead: The following example sets transaction parameters.
...
image::transactions-preferences.png['The Query Options dialog, with transaction preferences set as follows.',674]
