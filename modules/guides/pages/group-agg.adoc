...
For more information and examples, see xref:n1ql:n1ql-language-reference/aggregatefun.adoc[Aggregate Functions].
...
For more information, see xref:n1ql:n1ql-language-reference/aggregatefun.adoc#aggregate-quantifier[Aggregate Quantifier].
...
For more information, see xref:n1ql:n1ql-language-reference/aggregatefun.adoc#filter-clause[FILTER Clause].

== Grouping the Results

By default, an aggregate function returns a single result for all the documents that the query selects.
It's often more useful to group the documents (by a different field) and return the aggregate result for each group.
...
For more information and examples, see xref:n1ql:n1ql-language-reference/groupby.adoc[GROUP BY Clause].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/groupby.adoc#having-clause[HAVING Clause].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/groupby.adoc#letting-clause[LETTING Clause].
