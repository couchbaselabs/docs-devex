...
// end::intro[]
If it cannot select a secondary query, the Query Service falls back on the primary index for the keyspace, if one exists.
...
For more information and examples, see xref:n1ql:n1ql-language-reference/selectintro.adoc#index-selection[Index Selection].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/keyspace-hints.adoc#index[INDEX].
