...
Every item in a database goes through the basic CRUD cycle, which is typical of an application's use of data.
...
The xref:clusters:data-service/data-service.adoc[Key-Value (KV) or Data Service] offers Couchbase clients the fastest and simplest way to create, retrieve or mutate data where the key is known.
