...
Couchbase stores its xref:server:learn:data/data.adoc[data] as either JSON or Binary _documents_ with unique IDs (primary keys) by which they can be located.
