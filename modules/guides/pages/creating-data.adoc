...
Couchbase stores its xref:learn:data/data.adoc[data] as either JSON or Binary documents with unique IDs (primary keys) by which they can be located.

Documents are organized and grouped in buckets using xref:tutorials:buckets-scopes-and-collections.adoc[scopes and collections].
