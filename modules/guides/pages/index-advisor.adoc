...
For more information, see xref:tools:query-workbench.adoc#index-advisor[Index Advisor].
--
...
For more information, see xref:n1ql:n1ql-language-reference/advise.adoc[ADVISE].
--
...
For more information, see xref:n1ql:n1ql-language-reference/advisor.adoc#advisor-string[ADVISOR(string)].
--
====
...
For more information, see xref:n1ql:n1ql-language-reference/advisor.adoc#advisor-array[ADVISOR(array)].
...
For more information, see xref:n1ql:n1ql-language-reference/advisor.adoc#advisor-session-start[ADVISOR(start_obj)].
