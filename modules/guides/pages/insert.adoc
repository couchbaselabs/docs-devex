...
For more information and examples, see xref:n1ql:n1ql-language-reference/insert.adoc[INSERT].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/upsert.adoc[UPSERT].
