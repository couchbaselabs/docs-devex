...
Now decide which bucket and xref:clusters:data-service/scopes-collections.adoc[scope and collection] you want to import to, and create them if they do not already exist.
