...
xref:server:tools:cbimport.adoc[cbimport] command-line tool shipped with Couchbase Server,
...
Now decide which bucket and xref:server:learn:data/scopes-and-collections.adoc[scope and collection] you want to import to, and create them if they don't already exist.
