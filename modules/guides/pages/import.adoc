...
Importing data can be done from the Couchbase Server UI,
via the xref:tools:cbimport.adoc[cbimport] command-line tool shipped with Couchbase Server,
...
[source,csv]
----
include::4.2@nodejs-sdk:howtos:example$import.csv[]
----
--
...
[source,tsv]
----
include::4.2@nodejs-sdk:howtos:example$import.tsv[]
----
--
...
[source,json]
----
include::4.2@nodejs-sdk:howtos:example$import.json[]
----
--
...
[source,json]
----
include::4.2@nodejs-sdk:howtos:example$import.jsonl[]
----
--
====
...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=csv-tsv-import,indent=0]
----

[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=importCSV,indent=0]
----

[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=importTSV,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=csv-tsv-import,indent=0]
----

[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importCSV,indent=0]
----

[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importTSV;!omit,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importCSV_batch;!omit,indent=0]
----

[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importTSV_batch;!omit,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=csv-tsv-import,indent=0]
----

[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=csvStream,indent=0]
----

[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=tsvStream,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=csv-tsv-import,indent=0]
----

[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=csvImport,indent=0]
----

[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=tsvImport,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=json-jsonl-import,indent=0]
----
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=importJSON,indent=0]
----

[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=importJSONL,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=json-jsonl-import,indent=0]
----

[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importJSON,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importJSON_batch;!omit,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importJSONL;!omit,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=importJSONL_batch;!omit,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=json-jsonl-import,indent=0]
----

[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=jsonStream,indent=0]
----

[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=jsonlStream,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=json-jsonl-import,indent=0]
----

[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=jsonImport,indent=0]
----

[source,python]
----

include::4.2@python-sdk:devguide:example$python/import.py[tags=jsonlImport,indent=0]
----
...
Now decide which bucket and xref:tutorials:buckets-scopes-and-collections.adoc[scope and collection] you want to import to, and create them if they don't already exist.
...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=connect,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=connect,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=reactiveCollection,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=connect,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=connect,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$Import.csx[tags=upsertDocument,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=upsertDocument,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=JsonDocument,indent=0]
----

[source,java]
----
include::3.4@java-sdk:howtos:example$Import.java[tags=preprocess,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=importStream,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:howtos:example$import.js[tags=upsertDocument,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=key,indent=0]
----
[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=process,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=upsertDocument,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/import.py[tags=csvImportMulti,indent=0]
----
