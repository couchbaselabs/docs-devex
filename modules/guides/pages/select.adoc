...
image::elixir-query-context-set.png["The query context menu with `my-db.samples` selected"]
--
...
//For example, the following command sets the query context to `my-db.samples`.
