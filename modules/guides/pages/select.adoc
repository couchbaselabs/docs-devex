...
// tag::intro[]
To read data from a data source using {sqlpp}, you must use a selection query; in other words, a query using the `SELECT` statement.
// end::intro[]
...
For more information and examples, see xref:n1ql:n1ql-language-reference/selectclause.adoc[SELECT Clause].
...
The set of fields returned by the query is known as the ((projection)).
...
For more information and examples, see xref:n1ql:n1ql-language-reference/from.adoc[FROM Clause].
...
For more information and examples, see xref:n1ql:n1ql-intro/queriesandresults.adoc#query-context[Query Context].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/where.adoc[WHERE Clause].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/limit.adoc[LIMIT Clause].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/orderby.adoc[ORDER BY Clause].
