...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$StartUsing.csx[tag=n1ql-query,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$StartUsing.java[tag=n1ql-query,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$n1ql-hello-world.js[tag=n1ql-query,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/query_hello_world.py[tag=n1ql-query,indent=0]
----
