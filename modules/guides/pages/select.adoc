...
. Expand the *Query Context* list.
. Click the scope where you want to run your query.

image::query-context-set.png["The query context menu with `samples` selected", 456]
--
...
image::query-context-unset.png["The query context menu with the query context unset", 456]
--
