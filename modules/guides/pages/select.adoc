...
image::query-context-set.png["The query context menu with `my-db-1tqei3.samples` selected"]
--
...
image::query-context-unset.png["The query context menu with the query context unset"]
--
