...
. In the *Data Insights* sidebar, click the expander arrow next to your database name.
. Click the scope where you want to run your query.

image::elixir-query-context-set.png["The query context menu with `my-db-1tqei3.samples` selected"]
--
...
. Go to *Data Tools* > *Query*.
. In the *Data Insights* sidebar, click the expander arrow next to your database name.
. Click currently selected scope.

The Query Context will change to `Not Selected`.
