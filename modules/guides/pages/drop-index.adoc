...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=drop-primary,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=drop-named-primary,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=drop-primary,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=drop-primary,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=drop-named-primary,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=drop-primary,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=drop-named-primary,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=drop-secondary,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=drop-secondary,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=drop-secondary,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=drop-secondary,indent=0]
----
