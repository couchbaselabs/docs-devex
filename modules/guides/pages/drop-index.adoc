...
This statement has two possible syntaxes:
...
For more information and examples, see xref:n1ql:n1ql-language-reference/dropprimaryindex.adoc[DROP PRIMARY INDEX] and  xref:n1ql:n1ql-language-reference/dropindex.adoc[DROP INDEX].
--
...
+
--
To drop a secondary index, use the `DROP INDEX` statement.
This statement has two possible syntaxes:
...
For more information and examples, see xref:n1ql:n1ql-language-reference/dropindex.adoc[DROP INDEX].
--
