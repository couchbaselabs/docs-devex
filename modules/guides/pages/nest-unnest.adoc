...
({sqlpp} cannot support right outer nests, because objects from the right-hand side cannot be nested within an object that does not exist.)
...
| xref:cxx-sdk:howtos:sqlpp-queries-with-sdk.adocc[{cpp}]
