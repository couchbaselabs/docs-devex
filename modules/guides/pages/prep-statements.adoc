...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$/N1qlQueries.csx[tag=positional,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:howtos:example$/N1qlQueries.csx[tag=namedparameter,indent=0]
----
...
[source,javascript]
----
include::4.2@nodejs-sdk:devguide:example$nodejs/n1ql-queries-scoped.js[tag=queryplaceholders,indent=0]
----
...
[source,javascript]
----
include::4.2@nodejs-sdk:devguide:example$nodejs/n1ql-queries-scoped.js[tag=querynamed,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:howtos:example$n1ql_ops.py[tag=positional_options]
----

[source,python]
----
include::4.2@python-sdk:howtos:example$n1ql_ops.py[tag=positional]
----
...
[source,python]
----
include::4.2@python-sdk:howtos:example$n1ql_ops.py[tag=named_options]
----

[source,python]
----
include::4.2@python-sdk:howtos:example$n1ql_ops.py[tag=named_kwargs]
----
