...
[source,java]
----
include::3.4@java-sdk:howtos:example$Queries.java[tag=positional,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:howtos:example$Queries.java[tag=named,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:concept-docs:example$N1qlQueryExample.java[tag=n1ql_query_1,indent=0]
----
