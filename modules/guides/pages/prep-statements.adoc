...
* Use the cog icon icon:cog[] to display the Run-Time Preferences window before running the statement.
...
TIP: When you're executing a prepared statement, the `EXECUTE` statement provides another, easier way to supply parameter values.
See <<execute>>.
...
. In the first *name* box, enter `country`, and in the *value* box, enter `"France"`.
. Next to *Named Parameters*, click btn:[+] again.
. In the next *name* box, enter `altitude`, and in the *value* box, enter `500`.
. Choose btn:[Save Preferences].
. Run the following query.
...
For more information and examples, see xref:n1ql:n1ql-manage/query-settings.adoc[].
--
...
TIP: The SDK has different versions of the `Parameter` method for supplying a single named parameter, a collection of named parameters, a single positional parameter, or a list of positional parameters.
...
[source,csharp]
----
include::3.5@dotnet-sdk:howtos:example$N1qlQueries.csx[tag=positional,indent=0]
----
...
[source,csharp]
----
include::3.5@dotnet-sdk:howtos:example$N1qlQueries.csx[tag=namedparameter,indent=0]
----

For details, see https://docs.couchbase.com/sdk-api/couchbase-net-client/api/Couchbase.Query.QueryOptions.html[QueryOptions^].
--
...
TIP: The SDK has different versions of the `parameter` method for supplying named parameters or positional parameters.
...
[source,java]
----
include::java-sdk:devguide:example$java/Queries.java[tag=positional,indent=0]
----
...
[source,java]
----
include::java-sdk:devguide:example$java/Queries.java[tag=named,indent=0]
----

For details, see https://docs.couchbase.com/sdk-api/couchbase-java-client/com/couchbase/client/java/query/QueryOptions.html[QueryOptions^].
--
...
For details, see https://docs.couchbase.com/sdk-api/couchbase-node-client/interfaces/QueryOptions.html[QueryOptions^].
--
...
For details, see https://docs.couchbase.com/sdk-api/couchbase-python-client/couchbase_api/options.html#queryoptions[QueryOptions^].
--
====
...
If you do not, a name is generated automatically.
...
For more information and examples, see xref:n1ql:n1ql-language-reference/prepare.adoc[PREPARE].
--
...
[source,java]
----
include::java-sdk:devguide:example$java/N1qlQueryExample.java[tag=n1ql_query_1,indent=0]
----
...
For more information and examples, see xref:n1ql:n1ql-language-reference/execute.adoc[EXECUTE].
--
...
* xref:n1ql-rest-admin:index.adoc#tag-PreparedStatements[{sqlpp} Admin REST API for Prepared Statements]

Querying with SDKs:

* xref:c-sdk:howtos:n1ql-queries-with-sdk.adoc[C]
| xref:cxx-sdk:howtos:sqlpp-queries-with-sdk.adoc[{cpp}]
...
| xref:kotlin-sdk:howtos:n1ql-queries.adoc[Kotlin]
...
| xref:rust-sdk:howtos:sqlpp-queries-with-sdk.adoc[Rust]
...
| xref:cxx-sdk:concept-docs:n1ql-query.adoc#prepared-statements-for-query-optimization[{cpp}]
...
| xref:kotlin-sdk:howtos:n1ql-queries.adoc#prepared-statements[Kotlin]
...
| xref:rust-sdk:concept-docs:n1ql-query.adoc#prepared-statements-for-query-optimization[Rust]
