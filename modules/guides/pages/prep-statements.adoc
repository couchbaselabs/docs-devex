...
For more information and examples, see xref:settings:query-settings.adoc[Settings and Parameters].
--
...
[source,csharp]
----
include::dotnet-sdk:howtos:example$/N1qlQueries.csx[tag=positional,indent=0]
----
...
[source,csharp]
----
include::dotnet-sdk:howtos:example$/N1qlQueries.csx[tag=namedparameter,indent=0]
----
