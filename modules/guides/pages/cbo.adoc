= Create Efficient Queries with Cost-Based Optimizer
...
== Activate the Cost-Based Optimizer
...
. Choose btn:[Save Preferences] to save the preferences and return to the Query Tab.
...
=== Update Statistics for Expressions
