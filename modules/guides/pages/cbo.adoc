...
You can also configure a scheduled task to automatically check and update statistics using xref:n1ql:n1ql-language-reference/auto-update-statistics.adoc[Auto Updates Statistics (AUS)].
...
* xref:n1ql:n1ql-language-reference/auto-update-statistics.adoc[Auto Updates Statistics]
