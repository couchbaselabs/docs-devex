...
NOTE: If the Cost-Based Optimizer is unavailable or inactive, or if statistics are not available, the Query Service falls back on the legacy rules-based optimizer to generate the query execution plan.
...
During the scheduled window, AUS evaluates the existing statistics and updates them if they're outdated.
...
For more information and examples, see xref:n1ql:n1ql-language-reference/statistics-expressions.adoc[Update Statistics for Index Expressions].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/statistics-index.adoc[Update Statistics for a Single Index].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/statistics-indexes.adoc[Update Statistics for Multiple Indexes].
...
For more information and examples, see xref:n1ql:n1ql-language-reference/statistics-delete.adoc[Delete Statistics].
