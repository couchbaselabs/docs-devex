...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=defer-create-primary,indent=0]
----

[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=defer-create-secondary,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=defer-create-primary,indent=0]
----

[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=defer-create-secondary,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=defer-create-primary,indent=0]
----

[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=defer-create-secondary,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=defer-create-primary,indent=0]
----

[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=defer-create-secondary,indent=0]
----
...
[source,csharp]
----
include::3.4@dotnet-sdk:hello-world:example$IndexHelloWorld.csx[tag=defer-build,indent=0]
----
...
[source,java]
----
include::3.4@java-sdk:hello-world:example$IndexHelloWorld.java[tag=defer-build,indent=0]
----
...
[source,nodejs]
----
include::4.2@nodejs-sdk:hello-world:example$index-hello-world.js[tag=defer-build,indent=0]
----
...
[source,python]
----
include::4.2@python-sdk:devguide:example$python/index_hello_world.py[tag=defer-build,indent=0]
----
