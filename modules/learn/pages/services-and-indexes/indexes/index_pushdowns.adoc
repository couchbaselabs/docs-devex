...
.Index Projection
====
This example uses the `def_inventory_route_route_src_dst_day` index that can be made by the statement:
...
This example uses the `def_inventory_landmark_city` index that can be made by the statement:
...
This example uses the `def_inventory_landmark_primary` index that can be made by the statement:
