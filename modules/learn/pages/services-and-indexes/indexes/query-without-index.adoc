...
For a xref:billing:billing.adoc#free-trial-plan[trial database], sequential scan is available in the Query tab, and via cluster access credentials in the SDKs or Couchbase Shell.
