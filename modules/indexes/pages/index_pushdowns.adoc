...
:page-aliases: learn:services-and-indexes/indexes/index_pushdowns
...
* Refer to section xref:performance:index-scans.adoc[Scans] for more information.
====
...
See xref:performance:index-scans.adoc[Scans]
...
* xref:performance:index-scans.adoc#query-execution-details[Query Execution: Details]
...
* xref:performance:early-filters-and-pagination.adoc[Early Filters, Ordering and Pagination]
