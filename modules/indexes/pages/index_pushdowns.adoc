...
The index is wider in scope, that is, it has `sourceairport`, `destinationairport`, and `schedule.day` fields.
...
* Refer to section xref:index-scans.adoc[] for more information.
====
