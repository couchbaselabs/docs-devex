...
* Refer to section xref:index-scans.adoc[Scans] for more information.
====
...
See xref:index-scans.adoc[Scans]
...
* xref:early-filters-and-pagination.adoc[Early Filters, Ordering and Pagination]
