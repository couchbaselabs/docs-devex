...
Refer to xref:performance:index-scans.adoc[Index Scans] and xref:indexes:index-replication.adoc#index-consistency[Index Consistency] for further details.