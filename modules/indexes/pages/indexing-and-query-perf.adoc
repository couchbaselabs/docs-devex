...
:page-aliases: learn:services-and-indexes/indexes/indexing-and-query-perf,performance:indexing-and-query-perf
...
:covering-indexes: xref:covering-indexes.adoc
:bucket-analyzer: xref:clusters:query-service/query-workbench.adoc#insights-sidebar
...
Couchbase Capella is a distributed database that supports flexible data model using JSON.
...
[source,sqlpp]
----
include::example$create-idx-composite.n1ql[]
----
====
...
[source,sqlpp]
----
include::example$create-idx-expr.n1ql[]
----
====
...
[source,sqlpp]
----
include::example$create-idx-array.n1ql[]
----
====
...
For further information and examples, see {indexing-arrays}[].
...
[source,sqlpp]
----
include::example$create-idx-partial.n1ql[]
----
====
...
For further information and examples, see {covering-indexes}[].
...
For further information and examples, see {hyperscale-vector-index}[].
...
For further information and examples, see {composite-vector-index}[].
