...
Like Basic Keyspace Accessors, Advanced Keyspace Accessors use bucket bindings defined in the handler.
Unlike Basic Keyspace Accessors, though, Advanced Keyspace Accessors expose a set of options and operators that can be used to do the following:

* Set or retriever expirations
* Solve race conditions through CAS
* Manipulate KV items under high contention
