...
[NOTE]
====
When JWT Authentication is active with `jitProvisioning=true`, guardrails in the Eventing codebase restrict certain operations. 
Specifically, you cannot *create, import, or delete* Eventing Functions through the REST API. 
