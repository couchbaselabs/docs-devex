...
:description: Use the Capella UI to add Eventing Functions to the Eventing Service in your database.
:page-aliases: eventing/manage-functions.adoc
...
. In the *Databases* tab, select the database where you want to add a Function.
...
|Eventing Storage
|A bucket, scope, and collection currently defined on your database and where you want to store system data for your Eventing Function. 
...
When you set the Feed Boundary to `Everything`, the Function is invoked on all mutations available in your database.
...
For more information about terminology, see xref:eventing:eventing-terminologies.adoc[Eventing terminology].
...
* xref:eventing/deploy-eventing-functions.adoc[Deploy the Eventing Functions]
* xref:eventing/manage-eventing-functions.adoc[Manage the Eventing Functions]
