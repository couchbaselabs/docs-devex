...
These operations are accessible through a returned iterable handle.
...
{sqlpp} statements can refer to JavaScript variables using the `$variable` syntax.
These parameters are substituted by the corresponding JavaScript variable's runtime value.
