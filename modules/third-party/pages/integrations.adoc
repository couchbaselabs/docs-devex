...
** https://python.langchain.com/docs/integrations/document_loaders/couchbase[LangChain - Python Document Loader]
** https://python.langchain.com/docs/integrations/vectorstores/couchbase[LangChain - Python Vector Stores]
