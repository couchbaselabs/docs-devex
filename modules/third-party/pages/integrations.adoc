...
* https://developers.llamaindex.ai/python/examples/vector_stores/couchbasevectorstoredemo/[CouchbaseVectorStoreDemo Documentation]
...
Use the vector stores integration to create a Search index, store vectors, and run vector searches.

Use semantic and conversational caches to reduce calls to Large Language Models (LLMs), accelerating your LLM responses and lowering your costs. 
a|
*Python*

* https://python.langchain.com/v0.2/docs/integrations/providers/couchbase/[Official Couchbase LangChain Python Integration]
** https://python.langchain.com/docs/get_started/installation[Install LangChain for Python]
** Couchbase Python Document Loader
*** https://python.langchain.com/v0.2/docs/integrations/document_loaders/couchbase/[LangChain Documentation]
*** https://api.python.langchain.com/en/latest/document_loaders/langchain_community.document_loaders.couchbase.CouchbaseLoader.html[API Reference]
** Couchbase Python Vector Store
*** https://python.langchain.com/v0.2/docs/integrations/vectorstores/couchbase/[LangChain Documentation]
*** https://api.python.langchain.com/en/latest/vectorstores/langchain_couchbase.vectorstores.CouchbaseVectorStore.html#langchain_couchbase.vectorstores.CouchbaseVectorStore[API Reference]
** Couchbase Python LLM and Semantic Caches
*** https://python.langchain.com/v0.2/docs/integrations/llm_caching/#couchbase-cache[LangChain Documentation - LLM Cache]
*** https://api.python.langchain.com/en/latest/cache/langchain_couchbase.cache.CouchbaseCache.html#langchain_couchbase.cache.CouchbaseCache[API Reference - LLM Cache]
*** https://python.langchain.com/v0.2/docs/integrations/llm_caching/#couchbase-semantic-cache[LangChain Documentation - Semantic Cache]
*** https://api.python.langchain.com/en/latest/cache/langchain_couchbase.cache.CouchbaseSemanticCache.html#langchain_couchbase.cache.CouchbaseSemanticCache[API Reference - Semantic Cache]
** Couchbase Chat Message History Store (Conversational Cache)
*** https://python.langchain.com/v0.2/docs/integrations/memory/couchbase_chat_message_history/[LangChain Documentation]
*** https://api.python.langchain.com/en/latest/couchbase_api_reference.html#module-langchain_couchbase.chat_message_histories[API Reference]

*JavaScript*

* https://js.langchain.com/docs/get_started/installation[Install LangChain for JavaScript]
** https://js.langchain.com/docs/integrations/document_loaders/web_loaders/couchbase[LangChain - JavaScript Document Loader]
** https://js.langchain.com/docs/integrations/vectorstores/couchbase[LangChain - JavaScript Vector Stores]
| ✔
| ✔
| Community Supported
...
a| 
* xref:cloud:clusters:monitoring/alert-integration.adoc[]
...
[#standalone-query-and-admin-tools]
=== Standalone Query and Admin Tools
...
| LibreDB Studio
| An open source SQL++ editor and schema browser, self-hosted next to the cluster and used from a browser.
Reads through the Query Service and the management API over HTTP, with no SDK or native dependency, and discovers query ports from the cluster map.
Browsing and querying only: transactions, in-grid row editing and `EXPLAIN ANALYZE` are not offered.
Verified against Couchbase Server 8.0.2 Community; un-indexed collections need Server 7.6 or later, or a primary index.
a|
* https://github.com/libredb/libredb-studio[GitHub repo]
* https://github.com/libredb/libredb-studio/blob/main/docs/providers/couchbase.md[Couchbase provider reference]
|
| ✔
| Community Supported
|===
...
| xref:elasticsearch-connector:ROOT:getting-started.adoc[Getting Started docs]
| xref:elasticsearch-connector:ROOT:release-notes.adoc[Release notes & download links]
| xref:elasticsearch-connector:ROOT:autonomous-operations.adoc[AO Mode]
| Couchbase Officially Supported


| Kafka
| A plug-in for the Kafka Connect framework, which provides source and sink components.
| xref:kafka-connector:ROOT:index.adoc[Kafka connector docs]
| https://github.com/couchbase/kafka-connect-couchbase[GitHub repo]
| https://kafka.apache.org/uses[Use cases]
| Couchbase Officially Supported

| Power BI Connector
| Connects Couchbase to the Microsoft Business Intelligence Platform.
| xref:power-bi-connector::index.adoc[Power BI Connector documentation]
| xref:power-bi-connector::release-notes.adoc[Power BI Releases]
|
| Couchbase Officially Supported
...
| xref:spark-connector:ROOT:index.adoc[Couchbase Spark docs]
...
Our development team provides technical support on a best-effort basis.
