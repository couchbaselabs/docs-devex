...
| LangChain
a| Use the LangChain integrations to quickly start developing AI applications with Capella or Couchbase Server: 

* Use the document loader to get documents from your Couchbase database.
