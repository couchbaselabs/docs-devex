...
| Jira
| Consolidate information about critical- and warning-level events in Capella by sending notifications to an incoming webhook on Jira.
a| 
* xref:cloud:monitoring:alert-integration.adoc[]
* https://support.atlassian.com/cloud-automation/docs/jira-automation-triggers/[Jira Automation Triggers] 
* https://developer.atlassian.com/server/jira/platform/webhooks/[Webhooks]
| ✔
| ✖
| Couchbase Officially Supported
...
| Microsoft Teams 
| Consolidate information about critical- and warning-level events in Capella by sending notifications to an incoming webhook on Microsoft Teams.
a| 
* xref:cloud:clusters:alert-integration.adoc[]
* https://learn.microsoft.com/en-us/microsoftteams/platform/webhooks-and-connectors/how-to/add-incoming-webhook?tabs=newteams%2Cdotnet[Create Incoming Webhooks]
| ✔
| ✖
| Couchbase Officially Supported
...
| Slack
| Consolidate information about critical- and warning-level events in Capella by sending notifications to an incoming webhook on Slack.
a| 
