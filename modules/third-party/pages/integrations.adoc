...
| cbmigrate
a|
A utility to migrate data from other document databases into Couchbase.
Works from the command line, or our <<ide-integrations,IDE plugins>>.
a|
* https://github.com/couchbaselabs/cbmigrate[GitHub repo]
* https://www.couchbase.com/blog/migrate-from-mongodb-to-couchbase/[Blog with examples]
| ✔
| ✔
| Couchbase Community Support
|===
