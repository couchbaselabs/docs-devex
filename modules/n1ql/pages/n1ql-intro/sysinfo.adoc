...
xref:n1ql:n1ql-language-reference/auto-update-statistics.adoc#systemaus[system:aus]
xref:n1ql:n1ql-language-reference/auto-update-statistics.adoc#systemaus_settings[system:aus_settings]
|===
