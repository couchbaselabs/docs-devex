...
* To set the query context in the Query Workbench:
...
You can set query parameter values when you run the query, use the Query Workbench, or use the {sqlpp} REST API.
