...
The field must contain a sparse term-weight array, in which the first item is an array of integers representing terms, and the second item is an array of floating point numbers representing the corresponding term weights.

queryvec:: A sparse term-weight array, in which the first item is an array of integers representing terms, and the second item is an array of floating point numbers representing the corresponding term weights.
