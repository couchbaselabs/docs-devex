...
To change or delete an external library or the external function code, you must use the xref:guides:javascript-udfs.adoc[Couchbase Web Console] or the {sqlpp} xref:n1ql-rest-functions:index.adoc[Functions REST API].
