...
image::n1ql-language-reference/drop-function.png["Syntax diagram: see source code listing", align=left]
...
To change or delete a JavaScript library or the JavaScript function code, you must use the xref:guides:javascript-udfs.adoc[Couchbase Web Console] or the {sqlpp} xref:n1ql-rest-functions:index.adoc[Functions REST API].

When you drop a {sqlpp} managed user-defined function, the associated JavaScript function code is deleted also.
