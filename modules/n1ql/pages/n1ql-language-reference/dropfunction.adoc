...
To change or delete an external library or the external function code, see xref:guides:create-javascript-library.adoc#delete-udf[Delete a User-Defined Function Library].
