...
To change or delete an external library or the external function code, you must use the {sqlpp} xref:server:n1ql:n1ql-rest-api/functions.adoc[Functions REST API].
