...
* To set a memory quota with the UI, see xref:manage:manage-settings/general-settings.adoc#query-settings[Query Settings] in the General settings for Couchbase Capella.
