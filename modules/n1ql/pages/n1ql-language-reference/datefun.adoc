...
[source,ebnf]
----
include::partial$grammar/n1ql.ebnf[tag=format-specifier]
----
...
date1:: [Required] A string, or any valid xref:n1ql-language-reference/index.adoc[expression] which evaluates to a string, representing the date in a <<date-string,supported date format>>.
...
part::
A string, or any valid xref:n1ql-language-reference/index.adoc[expression] which evaluates to a string, representing the <<manipulating-components,component>> of the date to return.
+
...
part::
A string, or any valid xref:n1ql-language-reference/index.adoc[expression] which evaluates to a string, representing the <<manipulating-components,component>> of the date to extract.
+
...
This function has an alias `MILLIS_TO_LOCAL`.
...
This function has an alias `MILLIS_TO_ZONE_NAME`.
...
This function has an alias `STR_TO_ZONE_NAME`.
...
* `MILLIS_TO_LOCAL` is an alias for <<fn-date-millis-to-str>>
* `MILLIS_TO_ZONE_NAME` is an alias for <<fn-date-millis-to-tz>>
* `STR_TO_ZONE_NAME` is an alias for <<fn-date-str-to-tz>>