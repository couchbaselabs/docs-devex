...
:indexing-and-query-perf: xref:server:learn:services-and-indexes/indexes/indexing-and-query-perf.adoc
...
:query-workbench: xref:server:tools:query-workbench.adoc
...
* The xref:server:tools:query-workbench.adoc#index-advisor[Index Advisor] in the Query Workbench
