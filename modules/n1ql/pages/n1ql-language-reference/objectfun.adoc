...
The function is particularly useful when working with complex objects, as it allows you to filter fields based patterns using either regular expressions or exact matches.
