...
Unlike xref:n1ql-language-reference/keyspace-hints.adoc[positive keyspace hints], which direct the optimizer to use specific indexes or join methods, negative hints tell it what not to use.
