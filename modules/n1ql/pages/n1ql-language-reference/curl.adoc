...
. Press kbd:[Enter] or click anywhere outside the text field to save the URL.
...
====
The following {sqlpp} query and `curl` command fetch details about the address `"Half Moon Bay"` using the {url-google-maps}[Google maps API^].
