...
IMPORTANT: Join hints and ORDERED hints are not available in DELETE statements.
...
====
This example uses an optimizer hint to specify that the `def_inventory_hotel_city` index should be used for the query.
