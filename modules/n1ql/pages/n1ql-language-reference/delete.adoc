...
There are 21 documents in this collection with `country="France"`, shown for this example in Table view.
...
There are now 11 documents in this collection with `country="France"`, shown for this example in Table view.
...
<.> Documents with the first 10 ids&mdash;the offset&mdash;remain in the airline collection.
<.> After deleting 10 documents&mdash;the limit&mdash;1 more document remains in the collection.
====