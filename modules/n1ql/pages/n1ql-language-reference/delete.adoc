...
include::partial$grammar/dml.ebnf[tag=deletealt]
----

image::n1ql-language-reference/delete.png["Syntax diagram: refer to source code listing", align=left]

image::n1ql-language-reference/deletealt.png["Syntax diagram: refer to source code listing", align=left]
...
Then, you specify that you want to delete up to 10 documents, after skipping the first 10.
...
<.> Documents for the first 10 ids remain in the airline collection.
<.> After deleting the limit of 10 documents, 1 more document remains in the collection.
====