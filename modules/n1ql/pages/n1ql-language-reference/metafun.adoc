...
filter-obj1, filter-obj2, ...:: [Optional] One or more JSON objects that specify filtering criteria, such as which fields to redact, how to redact them, and whether to redact field names, values, or both.
+
