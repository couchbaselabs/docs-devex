...
This function extracts Data Definition Language (DDL) statements executed on 1 or more specified buckets and returns them as an array of strings.

You can use this function to retrieve definitions for buckets, scopes, collections, indexes, and sequences. 
You can then use these definitions for purposes such as replication, backup, or auditing.
