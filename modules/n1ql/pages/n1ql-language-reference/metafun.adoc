...
From Couchbase Server version 7.6.2 and later, use the `META()` function with the xref:searchfun.adoc[SEARCH() function] when you want to return XATTRs data through the Search Service and do not have a suitable Search index for your query. 
