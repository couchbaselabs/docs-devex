...
It can retrieve definitions for buckets, scopes, collections, indexes, sequences, and functions. 
It can also retrieve PREPARE statements for prepared queries.
