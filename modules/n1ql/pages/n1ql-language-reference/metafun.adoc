...
To extract multiple statement types, specify either an array of their string values or a single numeric value that represents the sum of their respective numeric values.
