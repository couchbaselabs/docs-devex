...
The term _collection_ is used here in a generic sense to refer to any array of objects, rather than in the specific sense of a xref:clusters:data-service/about-buckets-scopes-collections.adoc[Couchbase collection].
