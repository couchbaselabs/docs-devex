...
You cannot change core properties such as the bucket name and type, after creating the bucket.
...
* For managing buckets with the CLI, see {couchbase-cli-bucket-edit}[CLI Reference]. 