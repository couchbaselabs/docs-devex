...
WARNING: Please note that the examples below will alter the data the sample dataset.
          ...
          "~children": [
            {
              ...
              "bucket": "my-db",
              "index": "def_samples_airport_airportname_city_faa",
...
<1> An `IndexScan` to search for documents using the `def_samples_airport_airportname_city_faa` index.
