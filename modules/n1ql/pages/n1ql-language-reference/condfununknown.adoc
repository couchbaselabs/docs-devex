...
search1, search2, ...:: [At least 1 required] The value to compare against the expression.
result1, result2, ...:: [At least 1 required] The value to return if the corresponding search value matches the expression.
...
* Returns default if it is provided.
