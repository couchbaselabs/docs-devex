...
. In the *Search* tab, click either the name of an existing index, or btn:[Create Index] to open the Index Details menu.
. Click *General Settings*, open the *Default Analyzer* pull down, and select `keyword`.
+
image::elixir-flex-fts-index-keyword.png["FTS General Settings menu with Default Analyzer set to keyword",498,552]
