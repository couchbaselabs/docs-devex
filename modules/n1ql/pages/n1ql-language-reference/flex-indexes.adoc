...
:inserting-a-child-field: xref:search:create-type-mapping.adoc#field
:pre-constructed-analyzers: xref:search:customize-index.adoc#analyzers
:simple-queries: xref:search:run-searches.adoc
:index_pushdowns: xref:indexes:index_pushdowns.adoc
...
Full-text indexes have different semantics from {sqlpp} queries.
