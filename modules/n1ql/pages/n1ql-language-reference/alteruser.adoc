...
Use the ALTER USER statement to update an existing user's attributes, such as their password, full name, and group. 
...
[horizontal]
username::
(Required) The unique identifier of the user you want to update.
