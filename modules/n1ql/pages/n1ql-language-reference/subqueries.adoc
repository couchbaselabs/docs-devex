...
[source,sqlpp]
----
SELECT count(*) FROM `my-db` .samples.airport t
LET x = t.geo
...
For example, the following example <<Q6,Q6>> has no explicit alias for ``my-db``.
