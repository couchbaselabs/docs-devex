...
--
* Returns MISSING if either value is MISSING.
* Returns TRUE if one value is NULL and the other is non-NULL.
* Returns FALSE if both values are NULL.
...
--
* Returns MISSING if either value is MISSING.
* Returns FALSE if one value is NULL and the other is non-NULL.
