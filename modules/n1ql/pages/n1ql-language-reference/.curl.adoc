...
For this example, unset the query context using the xref:tools/query-workbench.adoc#query-context[query context] drop-down menu in the Query Workbench, or the xref:n1ql:n1ql-manage/query-settings.adoc#query_context[query_context] request-level parameter.
