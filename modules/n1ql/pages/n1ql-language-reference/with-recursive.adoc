...
.Examples handling hierarchical or tree-structured data
====
Before trying out these examples, you must:
...
.Example finding the level of each employee in the organization
[source,sqlpp]
----
...
.Example resulting in the reporting hierarchy of the employees in the organization
[source,sqlpp]
----
