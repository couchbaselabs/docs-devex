...
CREATE INDEX country_idx ON airport(country, city)
       USING GSI
       WITH {"nodes": ["svc-dqi-node-001:18091", "svc-dqi-node-002:18091"]};

ALTER INDEX country_idx ON airport
WITH {"action": "move", "nodes": ["svc-dqi-node-001:18091", "svc-dqi-node-003:18091"]};
----
====
...
----
CREATE INDEX country_idx ON airport(country, city)
WITH {"nodes": ["svc-dqi-node-001:18091", "svc-dqi-node-002:18091", "svc-dqi-node-003:18091"]};

ALTER INDEX country_idx ON airport
WITH {"action": "move",
      "nodes": ["svc-dqi-node-001:18091", "svc-dqi-node-004:18091", "svc-dqi-node-005:18091"]};
----
====
