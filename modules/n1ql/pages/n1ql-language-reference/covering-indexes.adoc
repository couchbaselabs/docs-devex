...
See xref:clusters:data-service/import-data-documents.adoc#import-sample-data[Import Sample Data] for details.
...
Try these statements using [.api]`cbq` or the Query tab to see the query execution plan.
