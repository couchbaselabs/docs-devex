...
====
For this example, first insert the following documents into the default collection `_default` in the default scope in database:

include::ROOT:partial$query-context.adoc[tag=unset]

[source,sqlpp]
----
INSERT INTO _default VALUES ("account-customerXYZ-123456789",
{ "accountNumber": 123456789,
  "docId": "account-customerXYZ-123456789",
  "code": "001",
  "transDate":"2016-07-02" } );

INSERT INTO _default VALUES ("codes-version-9",
{ "version": 9,
...
CREATE INDEX idx_account_customer_xyz_transDate
    ON _default (SUBSTR(transDate,0,10),code)
...
FROM _default AS account
JOIN _default AS codesDoc ON KEYS "codes-version-9"
