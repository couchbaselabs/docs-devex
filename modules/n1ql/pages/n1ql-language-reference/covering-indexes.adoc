...
Try these statements using the Query Workbench to see the query execution plan.
...
[source,sqlpp]
----
INSERT INTO <bucket> VALUES ("account-customerXYZ-123456789",
{ "accountNumber": 123456789,
  "docId": "account-customerXYZ-123456789",
  "code": "001",
  "transDate":"2016-07-02" } );

INSERT INTO <bucket> VALUES ("codes-version-9",
{ "version": 9,
...
CREATE INDEX idx_account_customer_xyz_transDate
    ON <bucket> (SUBSTR(transDate,0,10),code)
...
FROM <bucket> AS account
JOIN <bucket> AS codesDoc ON KEYS "codes-version-9"
