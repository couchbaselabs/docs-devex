...
The query intelligently requests the indexer to perform grouping and aggregation in addition to range scan.
...
* xref:server:learn:services-and-indexes/indexes/index-scans.adoc#query-execution-details[Query Execution: Details]
* xref:n1ql:n1ql-language-reference/covering-indexes.adoc[Covering Indexes]
* xref:server:learn:services-and-indexes/indexes/index_pushdowns.adoc[Index Pushdown Optimizations]
* xref:server:learn:services-and-indexes/indexes/early-filters-and-pagination.adoc[Early Filters, Ordering and Pagination]
