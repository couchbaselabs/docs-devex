...
The USING AI statement provides best results when run from Couchbase Server 8.0 instances (both Enterprise and Community Editions).

If you're using the statement from Couchbase Capella, note the following limitations and workarounds.

* The Capella UI does not currently support the USING AI statement.
* You can successfully run the statement on Capella clusters using the cbq shell or SDK.
