...
See the {createindex}[CREATE INDEX] statement for details of the syntax.
...
For more information and examples, see <<Number of Partitions>>.
...
See the {index-with}[CREATE INDEX] statement for details of the syntax.
For more information and examples, see <<Partition Placement>>.
...
For more information and examples, see <<sizing-hints>>.
...
The partition keys should be immutable: its values should not change once the document is created.
