...
* INNER joins and LEFT OUTER joins support the LATERAL keyword in front of the right-hand side keyspace. RIGHT OUTER joins do not support the LATERAL keyword.
