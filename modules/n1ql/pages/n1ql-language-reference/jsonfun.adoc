...
----
SELECT 
    POLY_LENGTH("Hello, World!") as string_length,
    POLY_LENGTH(["Products", "Sales", "Engineering"]) as array_length,
    POLY_LENGTH({"id": 101, "name": "john", "email": "john@example.com"}) as object_length;
----
