...
====
For example, `default:{backtick}my-db{backtick}.samples.airline.{backtick}idx-name{backtick}` indicates the `idx-name` index on the `airline` collection in the `samples` scope in the `default:{backtick}my-db{backtick}` bucket.
====
...
====
For example, `default:{backtick}my-db{backtick}.def_type` indicates the `def_type` index on the default collection in the default scope in the `default:{backtick}my-db{backtick}` bucket.
====
...
====
For example, `def_type ON default:{backtick}my-db{backtick}` indicates the `def_type` index on the default collection in the default scope in the `default:{backtick}my-db{backtick}` bucket.

Similarly, `{backtick}idx-name{backtick} ON default:{backtick}my-db{backtick}.samples.airline` indicates the `idx-name` index on the `airline` collection in the `samples` scope in the `default:{backtick}my-db{backtick}` bucket.
====
