...
image::n1ql-language-reference/index-path-and-name.png["Syntax diagram: see source code listing", align=left]
...
image::n1ql-language-reference/index-name-on-keyspace.png["Syntax diagram: see source code listing", align=left]
