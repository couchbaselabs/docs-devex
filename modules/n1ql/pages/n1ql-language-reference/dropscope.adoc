...
bucket::
(Optional) An {identifier}[identifier] that refers to the {logical-hierarchy}[bucket] which contains the scope you want to delete.
...
====
This statement deletes a scope called `events` in the database.
