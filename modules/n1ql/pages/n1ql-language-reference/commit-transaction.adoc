...
// Cross-references
:durability: xref:server:learn:data/durability.adoc
:edit-bucket: xref:clusters:data-service/manage-buckets.adoc
...
image::n1ql-language-reference/commit-transaction.png["Syntax diagram: see source code listing", align=left]
