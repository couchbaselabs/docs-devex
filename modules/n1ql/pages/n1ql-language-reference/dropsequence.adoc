...
:description: The DROP SEQUENCE statement enables you to drop a sequence in a given keyspace.
...
include::n1ql-language-reference/sequenceops.adoc[tags=overview]
