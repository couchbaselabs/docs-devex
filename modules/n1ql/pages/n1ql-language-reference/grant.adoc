...
Even if you're granting a role to an entire bucket, you must specify the default scope (`_default`) and default collection (`_default`) as well.
...
* You can use either the singular or plural form of the keyword as it does not affect the number of users or groups the grant applies to.  
====
