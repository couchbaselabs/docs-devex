...
the {sqlpp} xref:server:n1ql-rest-api/functions.adoc[Functions REST API].
...
* To manage external libraries and external functions, see xref:server:n1ql-rest-api/functions.adoc[].
