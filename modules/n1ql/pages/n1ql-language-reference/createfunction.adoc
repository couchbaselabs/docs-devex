...
The JavaScript code can contain multiple function definitions, but these functions can only be referenced within this {sqlpp} user-defined function, and cannot be shared.
