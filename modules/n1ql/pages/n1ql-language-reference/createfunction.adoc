...
The CREATE FUNCTION statement provides two possible syntaxes for defining an external function: one where the function code is stored in a JavaScript library, and one for creating a {sqlpp} managed user-defined function.
