...
NOTE: A global function is not the same as a scoped function stored in the default scope in a bucket.
...
See <<create-function-inline>> or <<create-function-external>> below.
...
image::n1ql-language-reference/create-function.png["Syntax diagram: see source code listing", align=left]
...
image::n1ql-language-reference/create-function-inline.png["Syntax diagram: see source code listing", align=left]
...
image::n1ql-language-reference/params.png["Syntax diagram: see source code listing", align=left]
...
The CREATE FUNCTION statement provides two possible syntaxes for defining an external function: one where the function code is stored in a JavaScript library, and one for creating a {sqlpp} managed JavaScript function.
...
image::n1ql-language-reference/create-function-external.png["Syntax diagram: see source code listing", align=left]
...
[Optional] Use this parameter where the function code is stored in a JavaScript library.
...
[source,sqlpp]
----
include::example$udf/create-inline-variadic.n1ql[]
----

.Test
[source,sqlpp]
----
include::example$udf/test-inline-variadic.n1ql[]
----

.Result
[source,json]
----
include::example$udf/test-inline-variadic.json[]
----
====
...
[[ex-managed]]
.{sqlpp} managed JavaScript function
====
...
To view the geohash on a map, go to https://www.movable-type.co.uk/scripts/geohash.html[Geohashes^] and enter the string in the *Geohash* box.
