...
NOTE: This hint is only supported in xref:n1ql-language-reference/selectclause.adoc[SELECT] statements.
You cannot use it with DML statements such as xref:n1ql-language-reference/update.adoc[UPDATE], xref:n1ql-language-reference/delete.adoc[DELETE], or xref:n1ql-language-reference/merge.adoc[MERGE].
