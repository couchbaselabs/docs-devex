...
NOTE: The SAVE keyword is only available in Couchbase Server 8.1 and later. 
...
In Couchbase Server 8.1 and later, you can save a prepared statement and its query plan in persistent storage using the <<syntax, SAVE>> keyword. 
...
In Couchbase Server 8.1 and later, if you use the <<syntax, SAVE>> keyword, the plan survives node restarts and upgrades independently of statement propagation. 
