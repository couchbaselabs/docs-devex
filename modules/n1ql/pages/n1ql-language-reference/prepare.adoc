...
[source,sqlpp]
----
include::example$utility/prepare-rbac-select.n1ql[]
----
...
[source,sqlpp]
----
include::example$utility/prepare-rbac-update.n1ql[]
----
======
====
...
[source,sqlpp]
----
include::example$utility/prepare-q1.n1ql[]
----

.Result
[source,JSON]
----
include::example$utility/prepare-r1.jsonc[]
----
====
