...
[source,sqlpp]
----
include::example$n1ql-language-reference/prepare-rbac-select.n1ql[]
----
...
[source,sqlpp]
----
include::example$n1ql-language-reference/prepare-rbac-update.n1ql[]
----
======
====
...
[source,sqlpp]
----
include::example$n1ql-language-reference/prepare-q1.n1ql[]
----

.Result
[source,JSON]
----
include::example$n1ql-language-reference/prepare-r1.jsonc[]
----
====
