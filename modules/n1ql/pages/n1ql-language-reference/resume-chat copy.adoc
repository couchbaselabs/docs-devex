...
NOTE: Although the USING AI statement requires a Capella account, you can use it with any instances of Couchbase Server 8.0 or later.
...
// Commenting out the following lines for now as the statement does not work on the Query Workbench.
...
* xref:n1ql-rest-query:index.adoc[]
