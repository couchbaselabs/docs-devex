...
:description: Use the RECURSIVE keyword to enable recursive referencing in WITH clause common table expressions.
...
The SELECT definition for CTEs is split by the UNION/UNION ALL operators.
