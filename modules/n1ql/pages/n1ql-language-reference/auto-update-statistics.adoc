...
It's a number representing a duration in seconds.
...
Therefore, to minimize performance impact, it's important to schedule AUS to best suit the workloads of your cluster.
