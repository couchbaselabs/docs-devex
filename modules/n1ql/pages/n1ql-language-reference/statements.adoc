...
xref:n1ql:n1ql-language-reference/altercredentialstore.adoc[]
...
xref:n1ql:n1ql-language-reference/createcredentialstore.adoc[]
...
xref:n1ql:n1ql-language-reference/dropcredentialstore.adoc[]
