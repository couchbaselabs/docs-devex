...
NOTE: For compatibility with legacy versions of Couchbase Server, you can also use the DROP INDEX or DROP VECTOR INDEX statement to drop a named primary index.
...
For more information about user roles, see {roles}[Roles].
...
image::n1ql-language-reference/drop-primary-index.png["Syntax diagram: see source code listing", align=left]
