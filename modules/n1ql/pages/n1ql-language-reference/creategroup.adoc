...
Use the CREATE GROUP statement to define a new group within Couchbase Server Role-Based Access Control (RBAC) system.
You can specify the group's name, description, and assign one or more roles to the group.
