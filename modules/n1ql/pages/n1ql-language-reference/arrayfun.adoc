...
Find how many total `public_likes` there are in the keyspace:
...
[source,sqlpp]
----
SELECT reviews[*].ratings FROM hotel WHERE city = "London"
----
====
...
[source,sqlpp]
----
SELECT array_star(reviews).ratings FROM hotel WHERE city = "London"
----
====
