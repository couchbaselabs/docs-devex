...
[source,sqlpp]
----
SELECT /*+ INDEX(airport def_samples_airport_airportname_city_faa) */ airportname
FROM airport
...
[source,sqlpp]
----
SELECT --+ INDEX(airport def_samples_airport_airportname_city_faa)
       airportname
FROM airport
WHERE city = "San Francisco";
----
...
----
SELECT /*+ USE_HASH(r) */
       /*+ INDEX(a def_samples_airport_airportname_city_faa) */
...
SELECT /*+ {"index": {"keyspace": "airport",
                      "indexes": "def_samples_airport_airportname_city_faa"}} */
       airportname, faa
FROM airport
WHERE city = "San Francisco";
----
...
[source,sqlpp]
----
SELECT /*+ INDEX(a def_samples_airport_airportname_city_faa) USE_HASH(r) */
       a.airportname, r.airline
FROM airport a
JOIN route r
ON a.faa = r.sourceairport
...
FROM airport
USE INDEX (def_samples_airport_airportname_city_faa)
WHERE city = "San Francisco";
----
====
...
[source,sqlpp]
----
EXPLAIN SELECT /*+ INDEX(airport def_samples_airport_airportname_city_faa) */
               airportname, faa
FROM airport
WHERE city = "San Francisco";
----
...
[
  {
    "optimizer_hints": {
      "hints_followed": [
        "INDEX(airport def_samples_airport_airportname_city_faa)"
      ]
    },
// ...
  }
...
[
  {
    "optimizer_hints": {
      "hints_followed": [
        "hint": "{\"index\":{\"indexes\":[\"def_samples_airport_airportname_city_faa\"],\"keyspace\":\"airport\"}}"
      ]
    },
// ...
  }
...
[source,sqlpp]
----
EXPLAIN SELECT /*+ USE_HASH(r) INDEX(a def_samples_airport_airportname_city_faa) */
               a.airportname, r.airline
FROM airport a
JOIN route r
ON a.faa = r.sourceairport
...
[
  {
    "optimizer_hints": {
      ...
      "hints_not_followed": [
        "INDEX(a def_samples_airport_airportname_city_faa): INDEX hint cannot be followed"
      ]
    },
// ...
  }
...
[source,sqlpp]
----
EXPLAIN SELECT /*+ USE_HASH(r) INDEX_SS(a def_samples_airport_airportname_city_faa) */
               a.airportname, r.airline
FROM airport a
JOIN route r
ON a.faa = r.sourceairport
...
[
  {
    "optimizer_hints": {
      ...
      "invalid_hints": [
        "INDEX_SS(a def_samples_airport_airportname_city_faa): Invalid hint name"
      ]
    },
// ...
  }
