...
You can use the CREATE USER statement to define a new user within the Couchbase Server Role-Based Access Control (RBAC) system. 
It lets you specify the user's basic attribute such as username, password, full name, and the group they belong to.
