...
// TODO: Remove `flag-devex-rest-api` feature flag when Data API is released.
...
| **total time** +
| The total time taken for the request -- that is, the time from when the request was received until the results were returned, including time spent in the queue.

ifdef::flag-devex-rest-api[]
It is analogous to `elapsedTime` in the xref:data-api-reference:index.adoc#tag/Default[Data API (Query Service)] response.
...
ifdef::flag-devex-rest-api[]
It is analogous to `cpuTime` in the xref:data-api-reference:index.adoc#tag/Default[Data API (Query Service)] response when profiling is enabled.
endif::flag-devex-rest-api[]
| Number
...
ifdef::flag-devex-rest-api[]
It is analogous to `usedMemory` in the xref:data-api-reference:index.adoc#tag/Default[Data API (Query Service)] response. 
endif::flag-devex-rest-api[]
| Number
...
ifdef::flag-devex-rest-api[]
It is analogous to `resultCount` in the xref:data-api-reference:index.adoc#tag/Default[Data API (Query Service)] response.
endif::flag-devex-rest-api[]
| Number
...
ifdef::flag-devex-rest-api[]
It is analogous to `resultSize` in the xref:data-api-reference:index.adoc#tag/Default[Data API (Query Service)] response.
endif::flag-devex-rest-api[]
| Number
...
ifdef::flag-devex-rest-api[]
It is analogous to `errorCount` in the xref:data-api-reference:index.adoc#tag/Default[Data API (Query Service)] response.
endif::flag-devex-rest-api[]
| Number
