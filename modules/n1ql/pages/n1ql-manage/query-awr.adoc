...
You can view AWR data and reports using the `cbqueryreportgen` tool or by querying the data directly from the target keyspace.

=== Using the `cbqueryreportgen` Tool 

This is the primary way to generate AWR reports, as it provides a comprehensive and user-friendly report formats. 
...
If this index is not created, the `cbqueryreportgen` tool will use sequential scans, which can impact performance.
