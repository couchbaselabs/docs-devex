...
For field names and meanings, see xref:n1ql-rest-admin:index.adoc#Vitals[Vital Statistics].
...
For field names and meanings, see xref:n1ql-rest-admin:index.adoc#Requests[Requests].
...
For field names and meanings, see xref:n1ql-rest-admin:index.adoc#Statements[Prepared Statements].
