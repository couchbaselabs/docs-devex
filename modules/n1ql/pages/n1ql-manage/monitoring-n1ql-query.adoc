...
* {sqlpp} from 
ifdef::flag-devex-tools[the cbq shell or]
the Query Workbench
...
For more details about database credentials, see xref:clusters:manage-database-users.adoc[].
...
ifndef::flag-devex-tools[]
The query plan contains the following attributes:

include::n1ql:partial$n1ql-rest-api/query/definitions.adoc[lines=699..749]
endif::flag-devex-tools[]
