...
* Use the {query-preferences}[Run-Time Preferences] window in the Query tab.
...
the Query tab as a sandbox to test queries in your Capella database.
Use
ifdef::flag-devex-rest-api[]
a REST API call or
endif::flag-devex-rest-api[]
...
ifndef::flag-devex-tools[]
[plantuml#query-options-named-parameters]
....
@startsalt
{
  <b>Named Parameters
  {
    name 0 | value 0
    "<font:monospaced>$country " | "<font:monospaced>"France""
    name 1 | value 1
    "<font:monospaced>$altitude" | "<font:monospaced>500     "
  }
}
@endsalt
....
...
ifndef::flag-devex-tools[]
[plantuml#query-options-numbered-parameters]
....
@startsalt
{
...
ifndef::flag-devex-tools[]
[plantuml#query-options-unnumbered-parameters]
....
@startsalt
{
  <b>Positional Parameters
