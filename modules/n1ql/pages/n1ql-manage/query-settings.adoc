...
* Use the {query-preferences}[Query Options] window in the Query tab.
...
The at sign `@` syntax is only supported in databases running Couchbase Server 7.6.0 or later.
...
In databases running Couchbase Server 7.6.0 and later, you can use either of these symbols as preferred.
