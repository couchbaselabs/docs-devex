...
def draw_cluster(x, y, z, color, dist=0.4, numpoints=10):
    ...
    for point in range(numpoints):
        ...
        ax.scatter(my_x, my_y, my_z, color=color, s=20, alpha=0.8,  edgecolors='black')
...
point_list += draw_cluster(0.8, 0.5, 0.7, 'red', 0.15, 20)
point_list += draw_cluster(0.1, 0.1, 0.5, 'blue', 0.1, 20)
point_list += draw_cluster(0.75, 0.2, 0.3, 'green', 0.2, 30)
point_list += draw_cluster(0.2, 0.8, 0.6, 'orange', 0.15, 20)
point_list += draw_cluster(0.1, 0.7, 0.15, 'purple', 0.1, 10)
point_list += draw_cluster(0.25, 0.3, 0.1, 'maroon', 0.1, 10)
point_list += draw_cluster(0.6, 0.9, 0.85, 'cyan', 0.1, 10)
...
plt.savefig('ivf-centroid-diagram.svg')  # Save as an image
plt.savefig('ivf-centroid-diagram.png')  # Save as an image
plt.show()