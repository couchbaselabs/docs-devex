...
If you have more than 10,000 vectors up to a maximum of 1,000,000, Couchbase recommends using either 10% of your total number of vectors or 10 times your number of centroids - whichever value is higher, up to a maximum of 1,000,000.
