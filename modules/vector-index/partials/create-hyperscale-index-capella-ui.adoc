...
.. In the *Number of clusters* field, enter or select the number of centroids to create in your index.
+
A larger value creates smaller centroids.
By default, set the *Number of clusters* to the number of vectors in your data divided by 1000.
