...
. (Optional) To add a field to use as a filter on the data included in your HyperScale Vector index, click btn:[+ Add Filter Field].
...
[TIP]
====
If you have less than 10,000 vectors in your index, Couchbase recommends setting the *Training List* value to your number of vectors.
If you have more than 10,000 vectors up to a maximum of 1,000,000, use either 10% of your total number of vectors or 10 times your number of centroids - whichever value is higher, up to a maximum of 1,000,000.
