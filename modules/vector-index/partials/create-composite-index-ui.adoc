To create a Composite Vector index with the Couchbase Web Console:
...
. Under *Vector Field*, in the *Field* list, select the vector field to use in your Composite Vector index.
...
+
. (Optional) To confirm your Composite Vector Index configuration:
