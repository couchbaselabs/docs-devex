...
:description: You can extend a Couchbase {product-name}'s Global Secondary Index (GSI) with a single vector column to enable hybrid queries to find semantically-related content.
:stem: 
:page-toclevels: 3
