...
[source,sqlpp]
----
WITH {  "dimension":<dimensions> , "similarity":"<similarity-function>", "description":""}; 
----

* `dimension` in an integer value that sets the number of dimensions in the vector.
This value is determined by the embedded model you used to embed the vectors.
...
* `description` is the settings for the indexing algorithm. 
