...
If you wish to use a standalone or Docker installation of Couchbase, see xref:server:tutorials:couchbase-tutorial-student-records.adoc[Server Developer Tutorial]. 
