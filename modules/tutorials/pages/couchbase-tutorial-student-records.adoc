...
[horizontal]
Step 1:: xref:tutorial-install-server.adoc[Install the Couchbase Server]
Step 2:: xref:tutorial-create-database.adoc[Create a Database]
Step 3:: xref:java-tutorial/install-couchbase-java-sdk.adoc[Set Up the Couchbase Java SDK]
Step 4:: xref:java-tutorial/create-student-collection.adoc[Create a Student Collection]
Step 5:: xref:java-tutorial/create-course-collection.adoc[Create a Course Collection]
Step 6:: xref:java-tutorial/retrieve-documents.adoc[Retrieve Documents]
Step 7:: xref:java-tutorial/add-course-enrollment.adoc[Add Course Enrollments]