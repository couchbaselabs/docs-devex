...
Step 3:: xref:java-tutorial/set-up-couchbase-java-sdk.adoc[Set Up and Connect the Couchbase Java SDK]
Step 5:: xref:java-tutorial/create-records.adoc[Create Student and Course Records]
Step 6:: xref:java-tutorial/retrieve-records.adoc[Retrieve Records]
