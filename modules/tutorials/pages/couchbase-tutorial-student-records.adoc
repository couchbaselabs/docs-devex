...
Step 4:: xref:java-tutorial/connect-to-database.adoc[Connect the SDK to Your Database]
Step 5:: xref:java-tutorial/create-records.adoc[Create a Course Collection]
Step 6:: xref:java-tutorial/retrieve-records.adoc[Retrieve Documents]
