= Developer Tutorial: A Student Record System
:description: A brief tutorial that guides you through creating and deploying a cloud database on Capella to store student records. It also shows you how to connect the database cluster to your application.
...
[horizontal]
Step 1:: xref:create-couchbase-cluster.adoc[Create and Deploy a Cluster]
