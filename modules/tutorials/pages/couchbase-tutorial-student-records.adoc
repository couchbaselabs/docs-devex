...
:description: This tutorial walks you through downloading and installing Couchbase, and then creating a database to store student records.
...
IMPORTANT: This tutorial uses standalone or Docker installations of the Couchbase Server.
...
For example, you would need to access every single student record in your database to change the `credit-points`.
...
[horizontal]
Step 1:: xref:install-couchbase-server.adoc[Install the Couchbase Server]
Step 2:: xref:buckets-scopes-and-collections.adoc[Learn About Buckets, Scopes, and Collections]
Step 3:: xref:java-tutorial/install-couchbase-java-sdk.adoc[Install the Couchbase Java SDK]
Step 4:: xref:java-tutorial/creating-the-students-collection.adoc[Create a Student Collection]
Step 5:: xref:java-tutorial/creating-the-courses-collection.adoc[Create a Course Collection]
Step 6:: xref:java-tutorial/retrieving-documents.adoc[Retrieve Documents]
Step 7:: xref:java-tutorial/adding-course-enrollments.adoc[Add Course Enrollments]