...
If you get an `UnknownHostException` error in your console, go to your Java file and confirm that the endpoint matches the connection string provided by the Capella Operational cluster.
