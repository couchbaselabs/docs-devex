...
* If you get an authentication error, confirm that the username and password in your `ConnectStudent.java` file match the username and password you used when setting up the Couchbase database in your browser.
