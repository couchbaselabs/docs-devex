...
:description: Learn how to set up the Couchbase Java SDK to connect and interact with your student cluster.
...
To establish a connection between the Java SDK and your cluster, you must first obtain the connection string and configure the cluster credentials and IP address.  

To set up the cluster connection: 
...
. xref:cloud:clusters:allow-ip-address.adoc#add-allowed-ip[Add an allowed IP address]. 

.. Go to the *Allowed IP Addresses* page from the link provided on the screen.

.. Click btn:[Add Allowed IP].

. Create a new cluster access user.
