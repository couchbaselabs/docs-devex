...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <!-- 
        The `<dependencies>` section of the code block lists all the libraries required to build your application.
...
After setting up the Java SDK, you can xref:java-tutorial/create-student-collection.adoc[use the SDK to connect to Couchbase and add student records to your database].