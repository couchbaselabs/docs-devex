...
scope:: Stores collections.
When you create a new bucket, Couchbase provides you with a default scope called `_default`.
collection:: Contains a set of documents.
Couchbase provides you with a default collection called `_default`.
...
For more information about scopes and collections, see xref:learn:data/scopes-and-collections.adoc[].
