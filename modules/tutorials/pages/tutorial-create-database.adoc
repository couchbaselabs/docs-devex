= Create a Database
:description: Use buckets, scopes, and collections to partition your data and continue following the Student Record System tutorial.
:imagesdir: ../images
...
After setting up a database, you can xref:java-tutorial/install-couchbase-java-sdk.adoc[install a Couchbase SDK to write your first application].