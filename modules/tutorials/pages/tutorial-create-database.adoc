= Create a Database
:description: Create a database and use buckets, scopes, and collections to partition your data.
:page-topic-type: tutorial
:imagesdir: ../images
:page-pagination: full
:page-aliases: buckets-scopes-and-collections.adoc
...
To organize and manage your data in Couchbase, you can create buckets, scopes, and collections inside your database.
...
After setting up a database, you can xref:java-tutorial/set-up-couchbase-java-sdk.adoc[set up a Couchbase SDK and connect it to your database to write your first application].