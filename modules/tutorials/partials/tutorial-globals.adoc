...
:point-to-server: pass:q[This tutorial is designed for use with Couchbase Capella cloud services. If you wish to use a standalone or Docker installation of Couchbase, see https://docs.couchbase.com/server/current/getting-started/start-here.html[Getting Started with Couchbase Server].]
